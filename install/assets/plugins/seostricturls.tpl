 ...
 * SEO Strict URLs
 *
 * Enforces the use of strict URLs to prevent dup content
 *
 * @category    plugin
 * @version     1.0.1
 * @license     http://www.gnu.org/copyleft/gpl.html GNU Public License (GPL)
 * @package     modx
 * @author      Jeremy Luebke @ www.xuru.com
 * @internal    @events OnWebPageInit,OnWebPagePrerender
 * @internal    @modx_category Manager and Admin
 * @internal    @properties &editDocLinks=Edit document links;int;1 &makeFolders=Rewrite containers as folders;int;1 &emptyFolders=Check for empty container when rewriting;int;0 &override=Enable manual overrides;int;0 &overrideTV=Override TV name;string;seoOverride
 */
